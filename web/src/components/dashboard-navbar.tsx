...
export function DashboardNavbar() {
  ...
  return (
    <>
      {pathname.startsWith("/dashboard/dev/projects/") ? (<></>) : (<>      <nav className="fixed top-0 right-0 w-[calc(100%-256px)] border-b border-border/40 bg-background/45 backdrop-blur supports-[backdrop-filter]:bg-background/35 z-50 ">
