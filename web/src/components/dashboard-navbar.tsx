...
export function DashboardNavbar() {
  return (
    <>
      <nav className="fixed top-0 right-0 w-screen border-b border-border/40 bg-background/45 backdrop-blur supports-[backdrop-filter]:bg-background/35 z-50 flex items-center justify-center px-4">
        <div className="container flex h-20 items-center justify-between px-6 w-full">
