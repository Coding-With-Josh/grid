...
import { ProgramInteraction } from "@/components/solana/program-interaction";
import { SoonNetworkStatus } from '@/components/soon-network-status';
import { SoonTransactionViewer } from '@/components/soon-transaction-viewer';
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <div className="space-y-4">
        <Card>
          <SoonTransactionViewer />
        </Card>

        <div className="grid gap-4">
          <Card className="min-w-fit">
            <CardHeader>
              <CardTitle>SOON Network Status</CardTitle>
            </CardHeader>
            <CardContent>
              <SoonNetworkStatus />
            </CardContent>
                ...
                {recentActivity.map((activity) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className={`p-2 rounded-full ${activity.status === 'success' ? 'bg-[#14F195]/20' :
